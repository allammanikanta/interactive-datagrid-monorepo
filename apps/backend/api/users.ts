...
router.get("/", (req, res) => {
  res.json([
    ...
    { id: 10, name: "Jack Daniels", avatar: "https://i.pravatar.cc/40?img=10" },
    { id: 11, name: "Kathy Bates", avatar: "https://i.pravatar.cc/40?img=11" },
    { id: 12, name: "Leo Messi", avatar: "https://i.pravatar.cc/40?img=12" },
    { id: 13, name: "Mia Wallace", avatar: "https://i.pravatar.cc/40?img=13" },
    { id: 14, name: "Nina Simone", avatar: "https://i.pravatar.cc/40?img=14" },
    { id: 15, name: "Oscar Wilde", avatar: "https://i.pravatar.cc/40?img=15" },
    {
      id: 16,
      name: "Paul Atreides",
